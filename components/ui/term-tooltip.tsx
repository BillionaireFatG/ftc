...
const glossary: Record<string, string> = {
  ...
  "voltage": "Electrical pressure that pushes current through circuits. Battery provides voltage to motors.",
  "current": "Flow of electricity measured in Amps (A). Higher current = more power but faster battery drain.",
  "power": "Rate of energy transfer. Power = Voltage × Current. Higher power = stronger robot performance.",
  "resistance": "Opposition to electrical flow. All wires and components have some resistance.",
